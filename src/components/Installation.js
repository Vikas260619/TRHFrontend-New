...
function Installation() {
  return (
    <div>
        ...
        {/* <Common
                   name="Fire fighting sytem installation"

        /> */}
                            <img src="images/3.png" class="img-fluid" alt="image"/>

        <div className='container'>
  <h2 className="h3 block-title text-center py-5 font-weight-bold" style={{fontWeight:"700"}}>
  FIRE PROTECTION SYSTEMS

          </h2>
          <p className='text-center' >
            <strong className='text-center fs-4' style={{fontWeight:"400"}}>Wet and dry riser systems, Courtyard hydrant systems, Auto sprinkler systems, Pump house of auto/manual start types, Gaseous fire suppression systems
            </strong>
</p>
...
<div class="container">
  ...
  FIRE DETECTION AND ALARM SYSTEMS
          ...
          <p className='text-center'>
            <strong className='text-center fs-4' style={{fontWeight:"400"}}>Conventional type fire detection and alarm systems, Addressable type fire detection and alarm systems,  Aspiration / VESDA systems, Public Address and digital voice evacuation systems
