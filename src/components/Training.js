...
<Helmet>
      ...
      <div className="row text-center">
        <div class="">
          ...
          >
            Fire Service Motto <br />
            <h3 style={{ color: "red" }}>"WE SERVE TO SAVE"</h3>
          </h2>
          <h2
          ...
          <div className="" style={{ paddingLeft: "80px" }}>
            ...
            <ul class="fa-ul">
              ...
              <li className="fs-5 px-2">
                ...
                Fire Mockdrill & Evacuation drill
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="py-2 ps-1">
          ...
          >
            <li>
              ...
              professionals with a wealth of knowledge and expertise in fire
              safety.
            </li>
            <li>
              Tailored Training: We understand that every client is different,
              and we tailor our training programmes to meet their unique needs.
            </li>
            <li>
              Comprehensive Training: Our courses cover all aspects of fire
              safety, from prevention to response.
            </li>
            <li>
              Flexible Schedule: We offer flexible training schedules to
              minimize disruption to your business or organization.
            </li>
            <li>
              Competitive Pricing: We offer competitive pricing for all our
              training courses, without compromising on quality.
            </li>
          </ul>
        </div>
      </div>
