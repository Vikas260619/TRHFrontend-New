...
<div className="offwrap">
      <div className="main-content">
        <Common
          ...
          description="a single stack that combines the potent skills of four various platforms. Build effective web-based experiences by utilising the MEAN & MERN Stack MVP design."
        />
      </div>
      <Commonpage
     title="MERN stack"
     title2="development"
     title3="company"
     paragraph="a single stack that combines the potent skills of four various platforms. Build effective web-based experiences by utilising the MERN Stack MVP design. "
     imgsrc="images\mern.png"
     androidtitle="The combination of
     fantastic four"
     androidpara="MEAN/MERN uses the potential in four different command frameworks to reduce unnecessary work and avoid typical pitfalls while keeping your application in order. MEAN/MERN is used by developers all over the globe, who put an enormous amount of faith in the stack. It is so trusted that many top brands like PayPal, Netflix, and Uber use MEAN to deliver gratifying experiences to their millions of clients. "
     heding="Why you should choose MERN "
     heading1="stack development?"
     para="To ensure speed, efficiency, and scalability, MEAN Stack- is a JavaScript technology platform that can be used to develop robust, flexible, and feature-rich apps.back-end development. With MERN, the “R” represents ReactJS. MERN is the go-to tech stack for companies who wish to develop high-quality web applications. "
     para1="MERN is an open-source full-stack JavaScript framework, and it is made up of features that are free to use. Thus, any project that uses this fr ."
     ...
     para3="Most start-ups prefer to choose MERN technology as it is an open-source technology that is constantly being updated by tech experts worldwide  "
     para4="The MERN technology is so well documented that you can quickly deploy it. Also, with MERN, you do not have to develop everything.  "
     commontitle="Delivering futuristic MERN stack "
     commontitle2="development services"
     commonpara="If you are looking to hire a MERN Stack Web Development Company, you always want to pick the best. Softude is the top choice! Softude creates bespoke solutions for any business from various verticals. Whether it’s a start-up or a large enterprise, we design and develop solutions that are suitable for all types of businesses with total commitment and precision. "
     pointheading="Enterprise MERN Stack Development     "
     pointheading1="‍MERN Stack Consulting         "
     pointheading2="MERN Stack Application Development "
     pointheading3="MERN Stack CMS Development "
     pointheading4="MERN Stack CMS Developmen  "
     ...
     pointpara1="One of the most reputable MEAN/MERN Stack companies, Softude, has assisted numerous clients in developing the best application to meet their diverse business needs. We provide efficient MEAN/MERN Stack consultancy services using the latest technology. Our knowledge and experience make us the most effective MEAN/MERN Stack web development company. "
     pointpara2="Being a highly regarded MEAN/MERN Stack web development company, We provide the most efficient App development solutions within the market. Our developers use their extensive expertise and knowledge to create robust, reliable, scalable mobile and web-based applications. From eCommerce to job portals, we create different kinds of apps to meet the needs of different businesses.  "
     ...
     mainpara="Softude has set the standard as a renowned MEAN and MERN Stack Development Company to develop top-quality products for clients all over the globe. From the beginning, Softude has succeeded in providing customized MEAN Stack Services, resulting in some of the most ground-breaking products that showcase our creativity and our innovative development work."
     mainheading="Technologies under"
     mainheading1="MERN stack"
     mainpara1="MERN Stack is among the more user-friendly and flexible full-stack JavaScript developed to develop dynamic web-based applications. MEAN is an abbreviation for MongoDB, Express JS, Node JS, and AngularJS. The same goes with MERN; however, the “R” here represents ReactJS. Because of its versatility, the MERN stack is one of the most popular programming languages that work in a range of applications. .   "
     ...
     cardheading3="NodeJS for Web Serve "
     cardheading4="ReactJS: the “R” of MERN "
